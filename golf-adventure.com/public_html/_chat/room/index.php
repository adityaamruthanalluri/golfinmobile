<?php
    ...
    if (isset($_GET['name']) && isset($_SESSION['chat_userid'])): 
...
<head>
    ...
    <script type="text/javascript">
    	...
    	chat.init();
    	chat.getUsers(<?php echo "'" . $name ."','" .$_SESSION['chat_userid'] . "'"; ?>);
    	var name = '<?php echo $_SESSION['chat_userid'];?>';
    </script>
...
<body>
    ...
    <div id="page-wrap"> 
    	...
    	<div id="header">
        	...
        	<div id="you"><span>Logged in as:</span> <?php echo $_SESSION['chat_userid']?></div>
